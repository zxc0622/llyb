...
$(function() {
    $(document).click(function(e){
        var className = e.target.className == undefined ? "" : e.target.className ;
        var parentClassName = $(e.target).parent().attr("class") == undefined ? "" : $(e.target).parent().attr("class");
        if(className.indexOf("mh_date") < 0 && className.indexOf("calender") < 0 && parentClassName.indexOf("calender") < 0
            && parentClassName.indexOf("calenderContent") < 0
            && parentClassName.indexOf("calenderTable") < 0
            && parentClassName.indexOf("getyear") < 0
            && parentClassName.indexOf("tablebg") < 0
            && parentClassName.indexOf("calendertb") < 0
            && parentClassName.indexOf("calenderContent") < 0
            && parentClassName.indexOf("calenderContent") < 0
            ){
    ...
    $.fn.manhuaDate = function(options) {
		...
		$("#calender td").die().live("click",function() {	
			...
			if (dv != "&nbsp;"){
				...
				$(".calender").hide();
				//
				$("#calender").find("td").removeClass("tdtoday");
