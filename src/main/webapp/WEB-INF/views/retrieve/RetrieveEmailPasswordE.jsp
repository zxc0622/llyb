...
<html>
    <head>
        ...
        <style type="text/css">
            ...
            .new_password label{width:70px;display: block;}
            .new_password label span{color:red;}
            ...
            .confirm_new_pw .resend,.new_pw_bottom .save_new_pw{width:140px;margin-left: 15px;text-align: center;background-color: #5EC520;color:#fff;}
            .new_pw_bottom .phonev_return{width:140px;margin-left: 15px;text-align: center;background-color: #E5E5E5;color:#666;}
                   ...
                   <div class="fpw_step_box">
                    ...
                    <div class="new_password font_1">
                        <div class="set_new_pw">
                            ...
                            <input type="password" onblur="jiaoyanNew()" id="newPw">
                        ...
                        <div class="new_pw_bottom">
                            <label for="">&nbsp;&nbsp;&nbsp;</label>
                            <a href="javascript:void(0)" class="save_new_pw" onclick="savePassword()">保存</a>
		...
		function savePassword(){
        	...
        	if(newPw.length<6){
        		...
        		if(qrPw!=newPw){
            		...
            		$.ajax({
         				type : "POST",
         				url : "${ctx}/retrieve/updateEmailPassword",
         				data : "email=" + email +"&password=" + newPw,
         				dataType : 'text',  
         				success : function(data) { 
         					if(data=="ok"){
         						window.location.href="${ctx}/retrieve/retrieveEmailPasswordD";
         					}else{
         						mess(data);
         					}
         				}
