...
<body>
	<!--头部 start-->
	<c:set var="pagename" value="about"></c:set>
	<%@ include file="/WEB-INF/views/include/header_ws.jsp"%>
	<!--头部 end-->
	<!--中间部分start-->
	<div class="wrapper">
		<div class="main">
			<div class="wf-help-div">
				<div class="wf-help-div-center">
					<img src="${ctxStatic}/img/llhb/erweimaknowledge.jpg" alt=""
						width="164px" height="163px">
				</div>
				<p>扫描二维码查看固废知识库</p>
				<span></span>
			</div>
			<div class="wf-help-div">
				<div class="wf-help-div-center">
					<img src="${ctxStatic}/img/llhb/wf_help_03.png" alt="">
				</div>
				<p>联系客服</p>
