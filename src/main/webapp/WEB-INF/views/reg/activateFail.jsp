...
<html>
    <head>
        ...
        <title>优蚁环保-激活账号,环评报价,监测报价,危废服务,危废处置,固体废物,固废供应,环保设备</title>
        ...
        <style type="text/css">
            ...
            .find_pw_success .findpws_r{float:left;margin-left: 15px;}
    ...
    <body>
            ...
            <div class="headerBox">
                ...
                <div class="header_middle">
                    <h1 class="header_logo">
                        ...
                        <span class="welcome font_3">激活账户</span>
                    </h1>
                    <div class="clear"></div>
                </div>
                <!--头部中部部 end-->
        ...
        <!--  
        <div style="position: relative;left:600px;bottom: 40px">
                        <input type="button" value="返回注册首页" onclick="register();">
        </div>  
        -->
        <!-- main结束 -->
        ...
        <script type="text/javascript">
            ...
            function register(){
            	window.location.href="http://localhost:8080/llhb/reg";
            }
