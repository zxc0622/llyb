        ...
        <div class="header_middle">
            ...
            <div class="header_search">
                ...
                <div class="h_s_middle font_1">
                    <input type="search" name="title" value="${title }" placeholder="请输入你要搜索的内容" style="border:1px solid #ccc; margin-left:-1px;"/>
        ...
        <div class="main_rows">
        	<div class="main_left">
            	...
            	<c:forEach items="${quoList}" var="quo">
                	<li>
                        <a href="javascript:void(0)" class="m_r_ul_a tmui-ellipsis color_1">${quo.quo_title}</a>
                ...
                <div class="fanye font_1 color_1">
					...
					<c:set var="actionUrl" value="${ctx}/quoindex/search?title=${title}&pageNumber="/>
