                    ...
                    <form action="${ctx}/hyzl/saveEnterprise" method="post" id="formSubMit">
                        ...
                        <div class="tab_main_row ">
                                ...
                                <div class="row_right font1 tupian">
                                    ...
                                    <a href="javascript:void(0)" onclick="picSea(0)">[预览]</a>
                                </div>
                        ...
                        <div class="tab_main_row ">
                                ...
                                <div class="row_right font1" id="cityId">
                                    <select name="sheng" id="">
                                    	<option value="">${companyZl.prov}</option>
                                    </select>
                                    <select name="shi" id="">
                                    	<option value="">${companyZl.city}</option>
                                    </select> 
                                </div>
                        ...
                        <div class="tab_main_row ">
                                ...
                                <div class="row_right font1 tupian">
                                    ...
                                    <a href="javascript:void(0)" id="yyzzImg" onclick="picSea(2)">[预览]</a>
                                </div>
                        ...
                        <div class="tab_main_row ">
                                ...
                                <input type="text" value="${companyZl.name}"/>
                                </div>
