            ...
            <div class="ltht_liuyan">
                    ...
                    <c:forEach items="${two}" var="b">
                        <li class="clearfix">
                            ...
                            <div class="fl">
                                ...
                                <a class="isgreen finger" onclick="chakan('${b.mes_href}')" >查看</a>
                ...
                <div class="filp_box">
                       <div class="filp">
                           ...
                           <c:set var="actionUrl" value="${ctx}/forum/messageCallre/"/>
...
<script>
    $(function(){
        $(".tab_title>span:eq(1)").addClass('cur_tab').siblings().removeClass('cur_tab');
        $("form > div").eq(1).show();
        $(".tab_title>span").click(function(){
            var index=$(this).index();
            $(this).addClass('cur_tab').siblings().removeClass('cur_tab');
            location.href="${ctx}/forum/messageCall";
        });
    });
    function  chakan(str){
