...
<head>
    ...
    <style>
        ...
        .header_middle .header_search .h_s_middlebefore {
            z-index: 1;
            content: "";
            display: block;
            width: 20px;
        ...
        <div class="header_middle" style="height: 140px;">
            ...
            <div class="header_search" style="margin-left:106px">
                ...
                <div class="h_s_middle font_1">
                    ...
                    <a class="font_3" href="javascript:void(0);"
                       onclick="window.open('http://hbxq.yyhb365.com/youyipc.html');"
                       style="width:135px; margin-left:50px;background-color:#ee7800;">发布环保需求</a>
                </div>
    ...
    <div class="header_banner" style="margin-top: 15px;">
        ...
        <div class="banner_left">
            <ul class="b_l_nav">
                ...
                <li data-in="1"><a id="mon" href="javascript:void(0);" data-in="1">监测报价</a></li>
            </ul>
...
<script>
    $(function () {
        ...
        $("#mon").addClass("b_l_nav_sel");
        $("#mon").parent().siblings().find("a").removeClass("b_l_nav_sel");
    ...
    function envSubmit() {
        ...
        if ($.trim(tel) == "" || $.trim(code) == "" || province == 0 || city == 0 || offhead == 0 || offline == 0 || $.trim(projectname) == "") {
            showMess("请先完善信息");
    ...
    function monSubmit() {
        ...
        if ($.trim(phone) == "" || province == 0 || city == 0 || offhead == 0 || types == "" || $.trim(projectname) == "") {
            showMess("请先完善信息");
            ...
            $.ajax({
                type: "POST",
                url: "${ctx}/monprotection/monSave",
                data: "name="+name+"&phone="+phone+"&companyName="+companyName+"&pid=" + pid + "&province=" + province + "&city=" + city + "&country=" + country + "&offhead=" + offhead + "&offline=" + mount + "&projectname=" + encodeURIComponent(projectname) + "&value=" + types,
                dataType: 'text',
                success: function (data) {
                    location.href = '${ctx}/monprotection/tableSur?pid=' + pid;
                }
            });
        }
    }
