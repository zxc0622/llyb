...
<html>
    <head>
        ...
        <style>
            ...
            /*发布需求弹出框样式start */
			.require-box{width:298px;height:370px;background-color: #FFFFFF;border: 1px solid #CCC;font-family: "微软雅黑";position: absolute;z-index: 11;top: 34px;left: 234px;display:none;}
			.rb-item{margin-top: 5px;margin-left: 32px;position: relative;}
