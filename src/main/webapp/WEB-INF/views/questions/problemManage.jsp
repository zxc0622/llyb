...
<html>
    ...
    <body>
    <form action="delProblem"  method="post" id="formId">
            <!-- 右侧开始 -->
            <div class="main_right">
                <div class="m_r_position font_1">当前位置>常见问题维护>常见问题管理</div>
                <div class="tab_main">
                    <div>
                        <a href="${ctx}/questions/CommonProblemWH"class="btn new_tr">新增</a>
                    ...
                    <div >
                        <table class="zxgl_table">
                            ...
                            <tr id="index${info.id}">
                                ...
                                <td style="width:250px;"class="tmui-ellipsis">${info.quesTitle}</td>
                                <td style="width:120px;">${info.name}</td>
                                <td style="width:172px">${info.createDate}</td>
                                <td style="width:100px;">${info.showOrder}</td>
                                <td style="width:92px;">
                                    <a href="#" onclick="update(${info.id},${info.quesType})">修改</a>
                    ...
                    <div class="filp_box">
                        <div class="filp">
							...
							<c:set var="actionUrl" value="${ctx}/questions/CommonProblemList/"/>
                            ...
                            <c:set var="urlParas" value="?selectName=${selectName}" />
        ...
        <script type="text/javascript">
        	...
        	function update(obj,type){
        		location.href="${ctx}/questions/CommonProblemWH?id="+obj+"&quesType="+type;
        	}
        	//查询分类
        	function seachLb(){
        		$("#formId").attr("action","${ctx}/questions/CommonProblemList").submit();
        	}
        </script>
    </body>
</html>