...
<div class="main_right">
    ...
    <div class="tab_main">
        <div class="tab_title">
            <span onclick="goUrl('${ctx}/competition/order/competiting')">进行中</span>
            <span class="cur_tab">已完成</span>
        </div>
        <form action="">
            ...
            <div class="tab_main_row clearfix">
                ...
                <table style="width:715px;">
                    ...
                    <c:if test="${startOrder.order_sta eq 3}">
                    <tr>
...
<script>
    $(function(){
        ...
        $(".search_by_name a").click(function(){
        	goUrl("${ctx}/competition/order/competited?compTitle="+$(".search_by_name input").val());
        });
    });
