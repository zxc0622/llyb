...
<div class="main_right">
    ...
    <div class="tab_main">
        <div class="m_r_title">
            <span  class="m_r_tname">新建竞品</span>
            <span onclick="jump(2)">已发布</span>
            <span onclick="jump(1)">审核中</span>
            <span  onclick="jump(0)">未通过</span>
            <span onclick="jump(4)">已过期</span>
        </div>
        <form action="${ctx}/competition/inforMan/save" method="post">

            <div class="tab_main_row clearfix">
                <label for="">竞品类别</label>
                <div class="row_right font1">
                    <select id="s1" name="type_first">
                        <option  value="0" selected>请选择类型</option>
                        <c:forEach items="${kindone}" var="k" varStatus="sta">
                            <option value="${k.id}">${k.name}</option>
                        </c:forEach>
                    </select>
                    <select id="s2" name="type_second">

                    </select>
                    <select id="s3" name="type_third">
            ...
            <div class="tab_main_row clearfix">
                ...
                <div class="row_right font1">
                    <input type="text" name="comp_title" value="${m.comp_title}">
            ...
            <div class="tab_main_row clearfix">
                ...
                <div class="row_right font1">
                    <select class="addr1" name="prov_id">
                        ...
                        <select class="addr2" name="city_id">
...
<%--
            ...
            <div class="tab_main_row clearfix">
                ...
                <div class="row_right font1">
                    <input type="text" style="width:126px;" name="amount" id="quality" value="${m.amount}">
                    <select name="unit">
            ...
            <div class="tab_main_row clearfix">
                ...
                <div class="row_right font_1 report">
                    ...
                    <div class="pic_wait_1 imagshow">
                        <a class="a_1" href="javascript:parent.comPic(0);" ><img class="imgshow" alt="等待上传" src="${m.testing_report}"  >等待上传</a>
            ...
            <div class="tab_main_row clearfix" style="height:155px;">
                ...
                <div class="row_right font1" style="width:600px;">
                    <div class="pic_wait_1 imagshow">
                        <a class="a_1" href="javascript:parent.comPic(1);" ><img class="imgshow" alt="等待上传" src="${m.pic1}"  >等待上传</a>
                    ...
                    <div class="pic_wait_1 imagshow">
                        <a class="a_1"  href="javascript:parent.comPic(2);"><img class="imgshow"  alt="等待上传" src="${m.pic2}">等待上传</a>
                    ...
                    <div class="pic_wait_1 imagshow">
                        <a class="a_1" href="javascript:parent.comPic(3);"><img class="imgshow" alt="等待上传" src="${m.pic3}">等待上传</a>
                        <a class="a_2" href="javascript:parent.comPic(3);">&nbsp;</a>
                        <a class="a_3" href="javascript:picSea(3);">&nbsp;</a>
                        <a class="a_4" href="javascript:picDel(3);" >&nbsp;</a>
                    </div>
            ...
            <div class="tab_main_row clearfix">
                ...
                <div class="row_right font_1">
                    <select id="birthyear" style="width:80px;" >
                        <option>2015</option>
                    </select>
                    年
                    <select id="birthmonth" onchange="showbirthday()" style="width:50px;">
                        <option>09</option>
                    </select>
                    月
                    <select id="birthday" style="width:50px;">
                        <option>01</option>
                    </select>
                    日
                    <select id="birthhour" style="width:50px;">
                        <option>20</option>
                    </select>
                    时
            ...
            <div class="tab_main_row clearfix">
                ...
                <div class="row_right font_1">
                    <select id="zhouqi" name="comp_period">
            ...
            <div class="tab_main_row clearfix">
                ...
                <div class="row_right font_1 promise">
                    <input type="text" id="promise" style="width:150px;" name="margin_money" value="${m.margin_money}">&nbsp;元
                </div>
            </div>
            ...
            <div class="tab_main_row clearfix">
                ...
                <div class="row_right font_1 beginP">
                    <input type="text" id="beginP" style="width:150px;" name="starting_price" value="${m.starting_price}">&nbsp;元
                </div>
            </div>
            ...
            <div class="tab_main_row clearfix">
                ...
                <div class="row_right font_1">
                    <select id="zuidi" name="least_increase">
            ...
            <div class="tab_main_row clearfix">
                ...
                <div class="row_right font_1">
                    <textarea style="margin-left: 0px;display: none;" name="comp_announ"  id="compannoun" cols="85" rows="30"></textarea>
          ...
          <div class="tab_main_row clearfix">
                ...
                <div class="row_right font_1">
                    <textarea style="margin-left: 0px;display: none;"   id="compdesc"  cols="85" rows="30"></textarea>
           ...
           <%-- <input type="hidden"  id="announ" value="" name="comp_announ">--%>
            ...
            <input type="hidden"  id="sta" value="1" name="sta">
            <input type="hidden"  id="comp_sta" value="0" name="comp_sta">
...
<script type="text/javascript">
    $(function(){
        ...
        if('${m.plat_test}' == 'true'){
            $("#jiance").css("background-color","#5ec520").addClass("xuanzhong");
        }
        $(".addr1").change(city);
    ...
    function  subfirst(){
        ...
        if(!promise||!uecon||!uedet||!mount||!beginP||!s1||!s2||!s3||($.trim(title).length < 2 || $.trim(title).length > 30)||(!arr1||!arr2)){
            parent.showMess("完善信息或填写符合要求的信息！");

        }else if(!shuzi(mount)||!shuzi(beginP)||!shuzi(promise)){
