    ...
    <div class="tab_main">
        ...
        <form action="${ctx}/competition/inforMan/save">
            ...
            <div class="tab_main_row clearfix" style="height:155px;">
                <label for="" style="height:60px;">竞品图片<br>（视频）</label>
                <div class="row_right font1" style="width:600px;">
                    ...
                    <span class="tip_span_pic">图片最佳尺寸为3M，视频最佳尺寸为20M，&nbsp;<a href="javascript:void(0);">上传遇到问题？</a></span>
                </div>
            </div>
            ...
            <div class="tab_main_row clearfix">
                ...
                <div class="row_right font_1 beginP">
                    <input readonly type="text" id="beginP" style="width:150px;" name="starting_price" value="${m.starting_price}">&nbsp;元
                </div>
            </div>
