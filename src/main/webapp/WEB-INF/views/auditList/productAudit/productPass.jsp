    ...
    <div class="tab_main">
        ...
        <form action="">
            ...
            <div class="tab_main_result">
            	<table>
                    ...
                    <tr>
                        ...
                        <td><a href="${ctx}/mall/detail/${pro.id}" target="_blank" style="color:#ee7800;">查看</a></td>
            ...
            <div class="filp_box">
                ...
                <c:set var="actionUrl" value="${ctx}/auditList/productAudit/pass/"/>
...
<script>
    ...
    /*  //上一页
   	$(".prev_page").click(function(){
   		...
   		if(curPage!=1){
   			curPage--;
   	   		location.href="${ctx}/auditList/productAudit/pass?pageNum="+curPage+"&typeFirst=${typeFirst}&proName=${proName}";
   		}
   	});
   	//下一页
  	...
  	//跳转
   	...
   	//搜索
   	function searchPro(){
   		location.href="${ctx}/auditList/productAudit/pass?typeFirst="+$(".tab_main_row select option:selected").val()+"&proName="+$("#proName").val();
   	}
   	//重置
   	function clearAll(){
