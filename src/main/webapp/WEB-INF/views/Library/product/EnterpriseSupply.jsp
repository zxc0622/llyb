            ...
            <div class="qy_m_r">
                <div class="qy_m_r_div">
                    <div class="qy_m_r_d_title">
                        <span>供应产品</span>
                        <a class="changediv-a" href="${ctx}/homepage/enterpriseCatalog/${enterpriseId}">以目录方式浏览</a>
                        <a class="changediv-a changediv-a-sel" href="${ctx}/homepage/products/${enterpriseId}">以橱窗方式浏览</a>
                    </div>
                    <div class="qy_m_r_d_main">
                        ...
                        <div class="fanye font_1 color_1">
							...
							<c:set var="actionUrl" value="${ctx}/homepage/products/${enterpriseId}"/>
