...
<html>
    <head>
        ...
        <style type="text/css">
            ...
            .tab_main2{width:753px;border:1px solid #F08300;height:30px;margin-bottom: 5px;overflow: hidden;background-color: #FFFDEE;}
                    ...
                    <form action="">
                        <div class="receive_table" style="border:0px solid #cccccc;">
                            <table id="table" class="list_tab" cellpadding="0" cellspacing="0">
                                ...
                                <tbody>
                                    <c:forEach items="${auditList}" var="list">
                                	<tr id="${list.id}">
                                        <td>
                                        <c:choose>
                                        ...
                                        <td>${list.key_words }</td>
                                        <td>${list.first_name}-${list.second_name }</td>
                                        <td>${list.prov_name}-${list.city_name}</td>
        ...
        <script type="text/javascript">
            $("#table tbody").on("click",".dele",function(){
				...
				var remindCount = 0;
				 $.ajax({
					type:"post",
					url:"${ctx}/memSerevice/remind/deleteAudit",
					data:"id="+id,
