 ...
 * 商品未通过
 * @author zhaoyl
 * @time 2015年10月21日20:07:18
 */
@ControllerBind(controllerKey="/proManage/notAgree")
public class ProductNotAgree extends Controller {
	private static final int sta = 0;//设置商品状态为未通过
	...
	public void searchAudit(){
		...
		if(searchModel==1){
			...
			List<Map<String,Object>> mapList = mapList(auditList,countAudit,curPage,num);			renderJson(mapList);
	...
	public void auditCount(){
		List<Record> list = Product.dao.findProBySta(sta,user.getId());
